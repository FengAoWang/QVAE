...
import torch
from model.utils import load_fold_indices, split_data, multiprocessing_train_fold, worker_function, train_fold
import random
...
if __name__ == "__main__":
    ...
    for dataset_name in dataset_list:
        for training_param in training_params_list:
            ...
            results.to_csv(
                f'result/{dataset_name}/integration/RBM_VAE_{dataset_name}_clustering_latentDim{training_params[training_param]["latent_dim"]}_{training_params[training_param]["normaliztion"]}_batchSize{training_params[training_param]["batch_size"]}_multiLayers_weight_decay.csv',
                index=True)
